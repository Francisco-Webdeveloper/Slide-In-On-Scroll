...
var checkSlide = function checkSlide() {
  images.forEach(function (img) {
    ...
    var slideInAt = window.scrollY + window.innerHeight - img.height / 2; // imageBottom => how much scroll down in pixels at the end of each
    // picture (bottom of the image)
    // offsetTop is the distance from the top of the image to the top of the window

    var imageBottom = img.offsetTop + img.height; // Is the image half shown?

    var isHalfShown = slideInAt > img.offsetTop; // if we are not scrolled past it
...
},{}]},{},["../../../../../.nvm/versions/node/v14.15.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main.js"], null)
